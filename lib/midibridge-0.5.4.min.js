...
!1};b.addConnection=function(a,b,c){return h()?(c=void 0===c?[]:c,f(d.addConnection(a,void 0===b?-1:b,c))):!1};b.removeConnection=function(a,b){return h()?f(d.removeConnection(a,b)):!1};b.disconnectAll=function(){return h()?f(d.disconnectAll()):!1};b.loadBase64String=function(a){return f(d.loadBase64String(a.replace(/data:audio\/mid[i]?;base64,/,"")))};b.playBase64String=function(a){return f(d.playBase64String(a))};b.loadMidiFile=function(a){return f(d.loadMidiFile(a))};b.playMidiFile=function(a){return f(d.playMidiFile(a))};
b.startSequencer=function(){d.startSequencer()};b.pauseSequencer=function(){d.pauseSequencer()};b.stopSequencer=function(){d.stopSequencer()};b.closeSequencer=function(){d.closeSequencer()};b.getSequencerPosition=function(){return d.getSequencerPosition()};b.setSequencerPosition=function(a){d.setSequencerPosition(a)};var x=function(){var a=function(a){this.data1=a.data1;this.data2=a.data2;this.status=a.status;this.channel=a.channel;this.noteName=b.getNoteName(this.data1,b.noteNameModus);this.statusCode=
b.getStatus(this.status);this.microsecond=a.microsecond;this.time=b.getNiceTime(this.microsecond);this.command==b.NOTE_ON&&0==this.data2&&(this.command=b.NOTE_OFF,this.status=this.command+this.channel)};a.prototype={toString:function(){var a;a=""+(this.noteName+" "+this.statusCode+" "+this.data1+" "+this.data2+" "+this.channel+" "+this.status);return a+=this.microsecond?this.microsecond+" "+this.time:""},toJSONString:function(){return this.microsecond?"{'notename':"+this.noteName+", 'status':"+this.status+
", 'data1':"+this.data1+", 'data2':"+this.data2+", 'microsecond':"+this.microsecond+", 'time':"+this.time+"}":"{'notename':"+this.noteName+", 'status':"+this.status+", 'data1':"+this.data1+", 'data2':"+this.data2+"}"}};return a}();b.MidiMessage=x;b.getNoteName=function(a,b){return o[b][a%12]+""+Math.floor(a/12-1)};b.getNoteNumber=function(a,b){var c=-1,a=a.toUpperCase(),d;for(d in o)for(var f=o[d],e=0,g=f.length;e<g;e++)if(f[e]===a){c=e;break}return-1===c?"invalid note name":noteNumber=12+c+12*b};
b.getStatus=function(a){return c[a]};b.getNiceTime=function(a){var b=a/1E3/1E3>>0,c=b/3600>>0,d=b%3600/60>>0,b=b%60,a=a/1E3-36E5*c-6E4*d-1E3*b+0.5>>0;return""+(0<c?c+":":"")+(0<c?10>d?"0"+d:d:d)+":"+(10>b?"0"+b:b)+":"+(0===a?"000":10>a?"00"+a:100>a?"0"+a:a)};b.getObject=function(a){var b=navigator.userAgent.toLowerCase();return-1!==b.indexOf("msie")||-1!==b.indexOf("webkit")?window[a]:document[a]};window.addEventListener||(window.addEventListener=function(a,b){window.attachEvent("onload",b)});window.midiBridge=
b})(window);