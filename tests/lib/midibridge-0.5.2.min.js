...
function(a){return e(c.loadMidiFile(a))};b.playMidiFile=function(a){return e(c.playMidiFile(a))};b.startSequencer=function(){c.startSequencer()};b.pauseSequencer=function(){c.pauseSequencer()};b.stopSequencer=function(){c.stopSequencer()};b.closeSequencer=function(){c.closeSequencer()};b.getSequencerPosition=function(){return c.getSequencerPosition()};b.setSequencerPosition=function(a){c.setSequencerPosition(a)};var q=function(){var a=function(a){this.data1=a.data1;this.data2=a.data2;this.status=
...
"{'notename':"+this.noteName+", 'status':"+this.status+", 'data1':"+this.data1+", 'data2':"+this.data2+", 'microsecond':"+this.microsecond+", 'time':"+this.time+"}":"{'notename':"+this.noteName+", 'status':"+this.status+", 'data1':"+this.data1+", 'data2':"+this.data2+"}"}};return a}();b.MidiMessage=q;b.getNoteName=function(a,b){return m[b][a%12]+""+Math.floor(a/12-1)};b.getNoteNumber=function(a,b){var c=-1,a=a.toUpperCase(),d;for(d in m)for(var e=m[d],f=0,g=e.length;f<g;f++)if(e[f]===a){c=f;break}return-1===
